...
# Logging
log_file = "training_log_convnext_imagenet80_0.csv"
...
model = ConvNeXtTiny(weights=None).to(device)
criterion = nn.CrossEntropyLoss(label_smoothing=0.1)  
optimizer = torch.optim.AdamW(model.parameters(), lr=2.5e-4, weight_decay=0.05)
...
for epoch in range(num_epochs):
    ...
    torch.save(model.state_dict(), f"models_imagenet80_0/convnext_imagenet80_0_epoch{epoch+1}.pth")
