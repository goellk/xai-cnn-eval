...
model_path = workspace_dir + "/training/vgg16_not_pretrained/models_imagenet80_5/vgg16_imagenet80_5_epoch1.pth"
...
# Load model
model = VGG16(num_classes=80)
model.load_state_dict(torch.load(model_path, map_location=device, weights_only=False))
model.to(device)
model.eval()
target_layer = model.vgg.features[28]
